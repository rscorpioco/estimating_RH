...
const SCHEDULE_RULES = [
  ...
  // ---- Send-this-form email actions ----
  // No fixed date — these are one-click "send what's already filled out" reminders, available
  // any time. attachHint calls out that nothing is actually attached for you (a static page
  // can't reach into Outlook's compose window that way); export the file first, then attach it.
  {
    id: "email6sLeveling",
    ...
    attachHint: "Attach the exported 6S Level Assignments & Bid Packages .xlsx (Export .xlsx, in that dialog).",
  },
  {
    id: "emailNof",
    ...
    condition: "NoContract",
    actions: ["email"],
    emailSubject: "New Opportunity Form",
    note: "Send the New Opportunity Form to ATF for Procore creation.",
    attachHint: "Attach the exported New Opportunity Form .xlsx (Export .xlsx, in that dialog).",
  },
  {
    id: "emailPrecon",
    ...
    condition: "HasContract",
    actions: ["email"],
    emailSubject: "Precon Start Up Form",
    note: "Send the Precon Start Up Form to your Finance Manager and Jill Altman.",
    attachHint: "Attach the exported Precon Start Up Form .xlsx (Export .xlsx, in that dialog).",
  },
  {
    id: "emailBond",
    ...
    type: "external",
    actions: ["email"],
    emailSubject: "Bond Request",
    note: "Send the Bond Request.",
    attachHint: "Attach the exported Bond Request .xlsx (Export .xlsx, in that dialog).",
  },
  {
    ...
    type: "external",
    actions: ["email"],
    emailSubject: "Builder's Risk Quote Request",
    note: "Send the Builder's Risk Quote Request.",
    attachHint: "Attach the exported Builder's Risk Quote Request .xlsx, plus the official Builder's Risk PDF once the manual portion is filled in.",
  },

  // ---- Additional calendar invites (anchored to 6S Level Approval, Sub Bid Due, or Client Due) ----
  {
    id: "completeKickoff",
    label: "Calendar Invite: Complete Kick Off Mtg (CD/Permit Set Only; if 6S team is needed)",
    anchor: "levelApproved",
    offsetDays: 3,
    time: null,
    allDay: true,
    type: "external",
    note: "Only applies at CD/Permit Set stage, and only if a 6S team is needed for this project.",
  },
  {
    id: "siteVisit",
    ...
    note: "Only if required per the ITB — check the uploaded Drawings/Specifications for a mandatory site visit date and add it to Outlook by hand.",
  },
  {
    id: "shareBidList",
  ...
  },
  {
    ...
    note: "4 weeks before sub bids are due — Aaron Rogers <aaron@scorpioco.com>; cc the Project Manager and Field Manager.",
  },
  {
    id: "pageTurn",
  ...
  },
  {
    ...
    allDay: true,
    type: "external",
    note: "48 hrs before due to the client.",
  },
  {
    id: "bidManualIssued",
  ...
  },
  {
    ...
    allDay: true,
    type: "self",
    note: "Within 24 hours of sub bids being due — are we good, ok, or screwed.",
  },
  {
    ...
    allDay: true,
    type: "external",
    note: "Final Draft ready for review 24-48 hrs before Internal — 1 week before sub bids are due.",
  },
  {
    id: "internalReview",
    label: "Calendar Invite: Internal Deliverable Review Mtg (Final Draft Ready for Review)",
    anchor: "clientDue",
    offsetDays: -2,
    time: null,
    allDay: true,
